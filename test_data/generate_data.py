...
if __name__ == "__main__":
    ...
    print(signal.lp2lp_zpk(np.array([.1+1j,.2,.3]), np.array([.3+0j,.2,.1,0.0-0.9j]), 1, 2))

    print(30*"-", "filter_design_test.lp2hp", 30*"-")
    print(signal.lp2hp_zpk(np.array([.1+1j,.2,.3]), np.array([.3+0j,.2,.1,0.0-0.9j]), 1, 2))

    print(30*"-", "filter_design_test.lp2bp", 30*"-")
    print(signal.lp2bp_zpk(np.array([.1+1j,.2,]), np.array([.3+0j,.1,0.0-0.9j]), 1, 2, 1))

    print(30*"-", "filter_design_test.lp2lp", 30*"-")
    print(signal.lp2bs_zpk(np.array([.1+1j,.2,]), np.array([.3+0j,.1,0.0-0.9j]), 1, 2, 1))

    print(30*"-", "filter_design_test.lp2lp", 30*"-")
    print(signal.bilinear_zpk(np.array([.1+1j,.2,]), np.array([.3+0j,.1,0.0-0.9j]), 1, 2))
    ...
    print(signal.zpk2tf(z=np.array([0.5-0.6j, 0.5+0.6j]), p=np.array([0.1+0.2j, 0.1-0.2j]), k=1.0))

    print(30*"-", "filter_design_test.zpk2sos", 30*"-")
    print(signal.zpk2sos(z=np.array([-1, -0.5-0.5j, -0.5+0.5j]), p=np.array([0.75, 0.8+0.1j, 0.8-0.1j]), k=1.0))
